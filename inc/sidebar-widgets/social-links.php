...
class Flatter_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'flatter_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Flatter ] Social Links', 'flatter-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'flatter-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'flatter-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'flatter-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'flatter-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'flatter-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'flatter-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'flatter-companion'); ?></label>
...
} // Class flatter_social_links ends here


// Register and load the widget
function flatter_social_links_widget_load() {
	register_widget( 'Flatter_social_links' );
}
add_action( 'widgets_init', 'flatter_social_links_widget_load' );