...
----------------------------------------*/
class flatter_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('flatter_instagram_photo',esc_html__('[ Flatter ] Intagram Photo','flatter-companion'),array(
			'description' => esc_html__('Flatter Instagram Photo Widget','flatter-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'flatter-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'flatter-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'flatter-companion'); ?></label>
...
if(!function_exists('flatter_instagram_widgets')):
	function flatter_instagram_widgets(){
		register_widget('flatter_instagram_photo');
	}
	add_action('widgets_init','flatter_instagram_widgets');
endif;
